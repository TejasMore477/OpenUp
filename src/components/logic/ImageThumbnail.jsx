...
const ImageThumbnail = ({
  ...
  return (
    <div className="relative backdrop-blur-sm bg-white/5 rounded-lg p-4 shadow-lg border border-white/20 hover:border-blue-500/20 transition-all duration-300 hover:shadow-blue-500/10">
      <div className="relative group">
        <img
          src={URL.createObjectURL(image.file)}
          alt={`preview-${index}`}
          className="w-full h-36 object-cover rounded-lg transition-transform duration-300 group-hover:scale-[1.02]"
