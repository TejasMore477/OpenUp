      ...
      <section className="relative  py-12 sm:py-20 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center  mb-6 sm:mb-16">
            <h1 className="text-2xl text-limicMist md:text-5xl font-Syncopate font-bold text-whitemb-2 sm:mb-6 animate-fade-in">
              About Me
            </h1>
            <p className="text-xs sm:text-sm text-gray-300 animate-fade-in-delay">
              A computer science student passionate about creating secure and efficient solutions
            </p>
          </div>

          {/* Mission Statement */}
          <div className="backdrop-blur-sm bg-white/5 rounded-xl p-4 sm:p-8 border border-white/20 transition-all duration-300 mb-12">
            <h2 className="text-sm sm:text-lg font-semibold text-white mb-4">My Mission</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {values.map((value, index) => (
              <div 
                key={index}
                className="backdrop-blur-sm bg-white/5 rounded-xl p-4 sm:p-8 border border-white/20 transition-all duration-300"
              >

                <h3 className="text-sm sm:text-lg font-semibold text-limicMist  mb-3 flex items-center gap-3">
                <span>
                  {value.icon}
                </span>{value.title}
                </h3>
          ...
          {/* Personal Section */}
          <div className="backdrop-blur-sm bg-white/5 rounded-xl p-4 sm:p-8 border border-white/20 transition-all duration-300">
            <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">My Journey</h2>
