...
function TermsOfService() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-darkTheme via-slate-900 to-darkTheme">
      <section className="relativepy-12 py-10 sm:py-20 sm:px-4">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="text-center mb-6 sm:mb-16">
            <h1 className=" font-Syncopate text-2xl md:text-5xl font-bold text-limicMist mb-6 animate-fade-in">
              Terms of Service
            </h1>
            <p className="text-xs sm:text-sm text-softVoilet animate-fade-in-delay">
              The most straightforward terms you'll ever read
            </p>
          </div>

          {/* Content */}
          <div className="backdrop-blur-sm bg-white/5 rounded-xl p-4 sm:p-8 border border-royalAmethyst/20">
            <div className="space-y-8">
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">The Simple Version</h2>
                <p className="text-softVoilet leading-relaxed text-xs sm:text-sm">
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">What You Can Do</h2>
                <ul className="list-disc list-inside text-softVoilet space-y-2 text-xs sm:text-sm">
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">What You Shouldn't Do</h2>
                <ul className="list-disc list-inside text-softVoilet space-y-2 text-xs sm:text-sm">
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">The Technical Disclaimer</h2>
                <p className="text-softVoilet leading-relaxed text-xs sm:text-sm">
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">Suggestions Welcome!</h2>
                <p className="text-softVoilet leading-relaxed text-xs sm:text-sm mb-4">
                ...
                <a 
                  ...
                  className="w-full sm:w-fit inline-flex text-xs sm:text-sm items-center gap-2 px-6 py-3 bg-gradient-to-r from-slate-700/90 to-slate-600/90 hover:from-slate-600/90 hover:to-slate-700/90 text-white rounded-lg transition-all duration-300 shadow-lg shadow-blue-500/5 hover:shadow-blue-500/10 border border-blue-500/10"
                >
