      ...
      <section className="relativepy-12 py-10 sm:py-20 sm:px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-16">
            <h1 className=" font-Syncopate text-2xl md:text-5xl font-bold text-limicMist mb-2 sm:mb-6 animate-fade-in">
              Privacy Policy
            </h1>
          ...
          <div className="backdrop-blur-sm bg-white/5 rounded-xl p-4 sm:p-8 border border-royalAmethyst/20">
            <div className="space-y-8">
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">TL;DR Version</h2>
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">The Fun Part</h2>
                <p className="text-softVoilet leading-relaxed mb-4  text-xs sm:text-sm">
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">What I Don't Do</h2>
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">The Technical Stuff</h2>
                <p className="text-softVoilet leading-relaxed  text-xs sm:text-sm">
              ...
              <div>
                <h2 className="text-sm sm:text-lg font-semibold text-limicMist mb-4">Questions?</h2>
                <p className="text-softVoilet leading-relaxed  text-xs sm:text-sm">
                ...
                <a 
                  ...
                  className="inline-flex w-full sm:w-fit text-xs sm:text-sm items-center gap-2 px-6 py-3 bg-gradient-to-r from-slate-700/90 to-slate-600/90 hover:from-slate-600/90 hover:to-slate-700/90 text-white rounded-lg transition-all duration-300 shadow-lg shadow-blue-500/5 hover:shadow-blue-500/10 border border-blue-500/10 mt-4"
                >
